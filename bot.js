...
console.log(process.env.CLEARDB_DATABASE_URL.match(/(@)[a-zA-Z\d-.]+/)[0].replace(/(@)/, ''));
console.log(process.env.CLEARDB_DATABASE_URL.match(/(\/\/)[a-zA-Z\d]+/)[0].replace(/(\/\/)/, ''));
console.log(process.env.CLEARDB_DATABASE_URL.match(/(:)[a-zA-Z\d]+/)[0].replace(/(:)/, ''));
console.log(process.env.CLEARDB_DATABASE_URL.match(/([a-zA-Z]\/)[a-zA-Z\d_]+/)[0].replace(/([a-zA-Z]\/)/, ''));
